 ...
 */
/**
 * Display counterpart of tools in components. 
 */
...
public class RateBySlicePanel extends AbstractBySlicePanel {
    ...
    private static final Logger m_log = 
	    Logger.getLogger( RateBySlicePanel.class ); 
	...
	/** columns **/
	int column[] = {
		RateBySliceCell.TYPE_KEY,
		RateBySliceCell.TYPE_MARGINAL_RATE,
		RateBySliceCell.TYPE_EFFECTIVE_RATE,
		RateBySliceCell.TYPE_FIXED
	};
	...
	protected final DataBySliceCell 
	createRBSC(OrderedMapOfDoublesObject omodo,
			int type) {
			...
			String[] texts = new String[] {
				...
				typeChooser.addActionListener(new java.awt.event.ActionListener() { 
					public void actionPerformed(java.awt.event.ActionEvent e) {    
						...
						jTable.repaint();
						rbspl.rbsDataChanged(); // fire data changed
					}
				});
		}
		return typeChooser;
	...
	private javax.swing.JComboBox getCurrencyChooser() {
	    if (currencyChooser == null) {
	        ...
	        currencyChooser=
	            new CurrencyChooserCombo(myRbs.getCurrency()) {
