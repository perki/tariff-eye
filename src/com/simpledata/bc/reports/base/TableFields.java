 ...
 * @version $Id: TableFields.java,v 1.2 2007/04/02 17:04:22 perki Exp $
 */
...
class TableFields {
	...
	public void addJasperField( String name ) {
		assert ! m_frozen : 
			"Field list must not be frozen yet."; 
	...
	public int size() {
		assert m_fields != null : 
			"Fields array must be initialized"; 
	...
	public String getBaseName( int i ) {
		...
		assert i<this.size() && i >= 0 : 
			"i must be in range of the fields array."; 
