...
public class LicenseUtils {
	...
	* Mix Keys
	*/
	static public String mixKey(String keyComputer, String keyCompany) {
		String tail = "";
		for (int i = 0; i < keyComputer.length() ; i++) {
			tail = tail + decToChar(charToDec(keyComputer.charAt(i)) 
			+ charToDec(keyCompany.charAt(i)));
		}
	...
	* Un Mix Keys
	*/
	static public String[] unMixKey(String key) {
